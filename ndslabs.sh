...
function start_all() {
    ...
    $BINDIR/kubectl create -f templates/oauth2-proxy.yaml -f templates/smtp/ -f templates/core/svc.yaml -f templates/core/etcd.yaml -f templates/core/apiserver.yaml
